      ...
      <div style={{ maxWidth: '1300px', width: '100%', position: 'relative', zIndex: 1 }}>
        ...
        <div className="fade-in" style={{
          ...
          {[
            ...
            { value: '2nd', label: 'Hackathon Win' },
            { value: 'Top 10', label: 'GDG Finalist' },
            { value: '8.2', label: 'CGPA' },
            { value: 'Fresher', label: 'Ready to Hire' }
          ].map((stat, idx) => (
            <div key={idx} style={{
              textAlign: 'center', padding: '15px', background: 'var(--primary-white)',
              border: '2px solid var(--border-gray)', borderRadius: '12px',
              ...
              <div style={{
                ...
                color: 'var(--primary-blue)', marginBottom: '4px'
              }}>
                {stat.value}
              </div>
              <div style={{
